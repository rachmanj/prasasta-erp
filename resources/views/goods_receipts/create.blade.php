                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Create Goods Receipt</h3>
                        ...
                        <form method="post" action="{{ route('goods-receipts.store') }}" id="grn-form">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="purchase_order_id" class="form-control select2bs4">
                                                <option value="">-- none (optional) --</option>
                                                @foreach ($purchaseOrders as $po)
                                                    <option value="{{ $po->id }}">{{ $po->order_no ?? '#' . $po->id }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="reference" value="{{ old('reference') }}"
                                                    class="form-control" placeholder="Delivery note or reference number">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" rows="2" placeholder="Receipt description">{{ old('description') }}</textarea>
                                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.select-item-btn', function() {
                ...
                if (lineType === 'item') {
                    window.itemSelector.open(function(item) {
                        ...
                        row.find('.price-input').val(item.last_cost_price ||
                        0); // Use cost price for goods receipts
            ...
            if (window.prefill) {
                ...
                if (window.prefill.purchase_order_id) {
            ...
            $('[name=purchase_order_id]').on('change', function() {
                const poId = $(this).val();
                if (poId) {
                    // Here you could add AJAX to fetch PO details and prefill the form
