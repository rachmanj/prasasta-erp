...
@section('breadcrumb_title')
    ...
    <li class="breadcrumb-item"><a href="{{ route('banking.cash-out.index') }}">Cash Out</a></li>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">New Cash Out Transaction</h4>
                </div>

                <form action="{{ route('banking.cash-out.store') }}" method="POST" id="cash-out-form">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <hr>
                        <h5>Expense Lines</h5>
                        <div id="expense-lines">
                            <div class="row expense-line">
                                <div class="col-md-4">
                                    <div class="form-group">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('banking.cash-out.index') }}" class="btn btn-secondary">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
...
@push('scripts')
    <script>
        ...
        `;
            ...
            // Form validation
            $('#cash-out-form').submit(function(e) {
