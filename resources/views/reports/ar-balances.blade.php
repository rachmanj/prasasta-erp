        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">AR Party Balances</h4>
                    <div class="btn-group float-right">
                        <button type="button" class="btn btn-success btn-sm dropdown-toggle" data-toggle="dropdown">
                            <i class="fas fa-download"></i> Export
                        </button>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{ route('reports.ar-balances', ['export' => 'csv']) }}">
                                <i class="fas fa-file-csv"></i> Export CSV
                            </a>
                            <a class="dropdown-item" href="{{ route('reports.ar-balances', ['export' => 'pdf']) }}">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-sm mb-0" id="ar-balances-table">
                            <thead>
                                <tr>
                                    <th>Customer</th>
