...
@section('content')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">GL Detail</h4>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-sm mb-0" id="gl-detail-table">
                            <thead>
                                <tr>
                                    <th>Date</th>
                                    <th>Journal</th>
    ...
    <script>
        ...
        const tbody = document.querySelector('#gl-detail-table tbody');
        async function load() {
