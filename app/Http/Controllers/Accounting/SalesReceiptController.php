...
class SalesReceiptController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return DB::transaction(function () use ($data) {
            ...
            // Generate receipt number using new numbering system
            $receiptNumber = $this->numberingService->generateNumber('sales_receipts', $data['date']);
            $receipt->update(['receipt_no' => $receiptNumber]);
            $total = 0;
